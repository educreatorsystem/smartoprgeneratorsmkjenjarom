# Sistem OPR PWA — SMK Jenjarom

Pakej ini disediakan untuk GitHub Pages.

## Fail utama
- `index.html` — sistem OPR PWA
- `manifest.webmanifest` — konfigurasi pemasangan PWA
- `sw.js` — service worker / cache aplikasi
- `Code.gs` — kod Google Apps Script
- `.nojekyll` — keserasian GitHub Pages

## Konfigurasi
- Sekolah: SEKOLAH MENENGAH KEBANGSAAN JENJAROM
